...
export default function EditCollectionPage() {
  ...
  if (pageLoading) {
    return (
      <AdminLayout title="Koleksiyon Düzenle">
        <div className="flex min-h-[520px] items-center justify-center rounded-[28px] border border-[#eadfd9] bg-white">
    ...
    return (
      <AdminLayout title="Koleksiyon Düzenle">
        <div className="rounded-[28px] border border-red-100 bg-white p-10 text-center">
          ...
          <h1 className="mt-5 text-xl font-semibold text-[#351f28]">
            Koleksiyon
            açılamadı
          </h1>
      ...
      >
        <div className="flex flex-col gap-4 xl:flex-row xl:items-end xl:justify-between">
          <div>
            ...
            <p className="mt-5 text-[10px] font-semibold uppercase tracking-[0.2em] text-[#a17b6c]">
              Koleksiyon Yönetimi
            </p>
            ...
            <p className="mt-2 text-sm text-[#8d7d83]">
              Koleksiyon bilgilerini,
              ürünlerini ve vitrin
              ayarlarını düzenle.
            </p>
          </div>
          ...
          <div className="flex gap-3">
            ...
            <button
              ...
              className="inline-flex h-12 min-w-[170px] items-center justify-center gap-2 rounded-2xl bg-[#351f28] px-5 text-sm font-semibold text-white shadow-[0_10px_25px_rgba(53,31,40,0.18)] transition hover:bg-[#482b37] disabled:cursor-not-allowed disabled:opacity-60"
            >
              {saving ? (
                <>
        ...
        <div className="grid gap-6 xl:grid-cols-[minmax(0,1fr)_340px]">
              ...
              <div className="grid gap-5 md:grid-cols-2">
                ...
                <label className="block md:col-span-2">
                  ...
                  <input
                    ...
                    placeholder="Koleksiyonun kısa alt başlığı"
                    className="h-12 w-full rounded-2xl border border-[#e5dad6] bg-[#fcfaf9] px-4 text-sm text-[#351f28] outline-none transition focus:border-[#b48a78] focus:bg-white focus:ring-4 focus:ring-[#b48a78]/10"
                  />
                </label>
            ...
            <section className="rounded-[26px] border border-[#eadfd9] bg-white p-6 shadow-[0_10px_35px_rgba(53,31,40,0.04)]">
              ...
              {productsLoading ? (
                <div className="flex min-h-[250px] items-center justify-center">
                  <div className="h-7 w-7 animate-spin rounded-full border-2 border-[#ddd0ca] border-t-[#351f28]" />
                </div>
                      ...
                      return (
                        ...
                        >
                          <div className="relative aspect-[4/3] overflow-hidden bg-[#f6efec]">
                            ...
                            <div
                              className={[
                                'absolute right-3 top-3 flex h-8 w-8 items-center justify-center rounded-full border shadow-sm',
                                selected
          ...
          <aside className="space-y-6">
            ...
            <div className="rounded-[22px] border border-[#eadfd9] bg-[#fbf8f6] px-5 py-4">
              <p className="text-[11px] leading-5 text-[#8e7e84]">
                Ürün sırasını
                değiştirdikten,
                ürün ekledikten veya
                çıkardıktan sonra
                <strong className="font-semibold text-[#5d454f]">
                  {' '}
                  Değişiklikleri
                  Kaydet
                </strong>{' '}
