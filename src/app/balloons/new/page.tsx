...
export default function NewBalloonPage() {
  ...
  async function handleSubmit(
    ...
    if (
      ...
      setError(
        'En az bir balon varyantı eklemelisiniz.',
      );
          ...
          <div className="mx-auto w-full max-w-[1500px] px-5 py-7 sm:px-7 lg:px-9 lg:py-9">
            <div className="flex flex-col gap-5 xl:flex-row xl:items-end xl:justify-between">
              <div>
                ...
                <p className="mt-2 max-w-2xl text-sm leading-6 text-[#8f7f85]">
                  Balonun temel bilgilerini, görsellerini ve satış varyantlarını oluşturun.
                </p>
              </div>
              ...
              <div className="flex gap-3">
                ...
                <button
                  ...
                  className="inline-flex h-12 min-w-[145px] items-center justify-center rounded-2xl bg-[#351f28] px-6 text-sm font-semibold text-white shadow-[0_12px_30px_rgba(53,31,40,0.16)] transition hover:-translate-y-0.5 hover:bg-[#472b36] disabled:cursor-wait disabled:opacity-60"
                >
                  {submitting
                    ? 'Kaydediliyor...'
                    : 'Balonu Kaydet'}
              ...
              <div className="space-y-6">
                <section className="rounded-[28px] border border-[#eadfd8] bg-white p-6 shadow-[0_12px_40px_rgba(53,31,40,0.035)] sm:p-7">
                  <SectionTitle
                    ...
                    description="Müşterinin mağazada göreceği temel balon bilgileri."
                  />
                  ...
                  0 ? (
                    <div className="mt-7 rounded-[22px] border border-dashed border-[#ded0ca] bg-[#fcfaf9] px-6 py-10 text-center">
                      ...
                      <p className="mt-1 text-xs text-[#9e8e94]">
                        Birden fazla balon görseli ekleyebilirsiniz.
                      </p>
                    </div>
                  ) : (
                    <div className="mt-7 grid gap-5 md:grid-cols-2">
                ...
                <section className="rounded-[28px] border border-[#eadfd8] bg-white p-6 shadow-[0_12px_40px_rgba(53,31,40,0.035)] sm:p-7">
                  ...
                  <div className="mt-7 space-y-5">
                    ...
                    <div>
                      ...
                      <p className="mt-2 text-right text-[10px] text-[#a7979d]">
                        {seoDescription.length} karakter
                      </p>
                    </div>
                  </div>
                </section>
                    ...
                    <div className="flex items-center justify-between gap-4">
                      <div>
                        ...
                        <p className="mt-1 text-[10px] leading-4 text-[#9e8e94]">
                          Balon mağazada satışa açık olsun.
                        </p>
                      </div>
            ...
            <div className="mt-7 flex flex-col-reverse gap-3 rounded-[26px] border border-[#eadfd8] bg-white p-4 shadow-[0_12px_40px_rgba(53,31,40,0.035)] sm:flex-row sm:items-center sm:justify-between sm:p-5">
              <p className="text-xs leading-5 text-[#9b8b91]">
                Kaydetmeden önce balon adı, fiyat ve varyant bilgilerini kontrol edin.
              </p>
              ...
              <button
                ...
                className="inline-flex h-11 min-w-[160px] items-center justify-center rounded-xl bg-[#351f28] px-5 text-sm font-semibold text-white transition hover:bg-[#472b36] disabled:cursor-wait disabled:opacity-60"
              >
                {submitting
                  ? 'Kaydediliyor...'
                  : 'Balonu Kaydet'}
